...
| `50` | Host reverse proxy selector | None / nginx / apache / openresty |
| `51–53` | Install chosen proxy | Certbot + default vhost. OpenResty installs the CrowdSec Lua bouncer when crowdsec was also chosen. |
